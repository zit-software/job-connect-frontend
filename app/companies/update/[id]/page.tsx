...
function CreateCompany({}: CreateCompanyProps) {
	...
	return (
		<>
			<div className='cursor-pointer fixed w-[60px] h-[60px] shadow-lg rounded-full bg-white bottom-10 right-10 p-5 flex justify-center items-center hover:shadow-xl transition-all hover:scale-105'>
				<i onClick={() => onOpenJob()} className='bx bxs-book-add text-center text-3xl'></i>
			</div>
											...
											<CardBody>
												<div className='grid grid-cols-12 gap-5' ref={parent}>
													...
													<div className='col-span-12'>
														<LocationPicker
															position={
																JSON.parse(values.mapPosition) as LatLngExpression
															}
